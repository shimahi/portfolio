    ...
    return (
      <div className="container">
            ...
            <div className="skill">
              ...
              <div className="skill__content">
                ...
                <p>
                  ...
                  <br/>
                  ソフトウェアの領域を離れた分野では、Arduinoを使った照明・空間演出に挑戦したり、映像制作や音効制作をやりたい気持ちがあります。
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="carrier me-item">
          ...
          <div className="profile-content">
            ...
            <p>
              ...
              <br/>
              業務外でもWebアプリを開発したりReact等の新しい技術を勉強したりするなど、日常的にWebプログラミングを継続する。
              <br/>
              婚約者が勤務する名古屋へ引っ越すため8月に退職。
            </p>
          </div>
        </div>
        ...
        <div className="stance me-item">
          ...
          <div className="profile-content">
            <p>
              Webコンテンツ制作の企画開発に携わり、マークアップ、サーバーサイド構築、デザインについて自分のスキルを活かせる仕事を探しています。
            </p>
            <p>
